...
void InputRest(String str)							//INPUT RESTRICTION
{
/*
...
{
//CASE OF INSERTION:-
System.out.print("ENTER THE \"ITEM\" FOR INSERTION: ");
int item=sc.nextInt();
...
{
//CASE OF DELETION:-
System.out.print("ENTER THE \"DIRECTION\" FOR DELETION: ");
str=sc.next();
...
static void Print(IDEQueueA q)							//PRINT
{
...
IDEQueueA q=new IDEQueueA(sc.nextInt());
...
System.out.print("ENTER THE DIRECTION FOR INPUT[INSERTION] RESTRICTION: ");
q.InputRest(sc.next());
