...
g.addVertex(0);
/*
SINCE IN HASHMAP AGR SAME KEY PR AGAIN ADD KREIN TO VO
UPDATED VALUE RKHTA HAI
SO OLD CONNECTIONS WOULD GET LOST
THEREFORE WE MANAGED THIS IN OUR addVertex()
*/
g.Print();
}
}
